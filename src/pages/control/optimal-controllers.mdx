...
### Minimum vs. Minimizer (#secMinimum)
...
form" (see ["Minimum vs Minimizer"](#secMinimum)):
...
*positive definite*
(see [wikipedia](https://en.wikipedia.org/wiki/Positive-definite_matrix>)). We will
...
This is matrix calculus (e.g., see [wikipedia](https://en.wikipedia.org/wiki/Matrix_calculus) or Chapter A.4.1 of [Convex Optimization (Boyd and Vandenberghe)](http://web.stanford.edu/~boyd/cvxbook/bv_cvxbook.pdf)). The result on
